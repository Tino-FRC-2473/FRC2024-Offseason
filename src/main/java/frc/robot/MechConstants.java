...
public final class MechConstants {
	...
	public static final double PID_CONSTANT_ROTATION_SWERVE_P = 0.5;
	public static final double PID_CONSTANT_ROTATION_SWERVE_D = 0.2;
	//Ones to use: public static final double PID_CONSTANT_ROTATION_SWERVE_P = 0.5;
	//Ones to use: public static final double PID_CONSTANT_ROTATION_SWERVE_D = 0.2;
